                    ...
                    <div key={step.label} className="flex items-center">
                        <div className="flex items-center gap-2.5">
                            <div
                                className={cn(
                                    ...
                                    isCompleted &&
                                        'bg-linear-to-br from-brand to-glow/70 text-brand-foreground shadow-[0_0_16px_-2px] shadow-brand/50',
                                    isCurrent &&
                        ...
                        {index < steps.length - 1 && (
                            <div className="w-8 sm:w-12 h-0.5 mx-3 rounded-full bg-border overflow-hidden">
                                <div
                                    className={cn(
                                        'h-full rounded-full bg-linear-to-r from-brand to-glow transition-all duration-500',
