...
export function Header() {
  ...
  return (
    <header className="sticky px-6 top-0 z-50 w-full bg-background/50 backdrop-blur-xl border-b border-border/60 shadow-sm shadow-black/5">
      {/* Bottom glow line */}
      <div
      ...
      <div className="container mx-auto flex h-14 items-center">
        ...
        <div className="flex flex-1 items-center justify-end gap-1">
          <Button
            variant="outline"
            className="hidden md:flex relative items-center gap-2 mr-2 text-muted-foreground w-64 justify-start rounded-full shadow-none"
            onClick={() =>
              window.dispatchEvent(new Event("open-global-search"))
            }
          >
            <Search data-icon="inline-start" />
            <span className="text-sm font-normal">Search tools...</span>
