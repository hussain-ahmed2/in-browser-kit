    ...
    <main className="max-w-3xl mx-auto space-y-8">
      <header className="text-center space-y-4">
        ...
        <p className="text-muted-foreground text-lg animate-fade-in-up stagger-3">
          Reduce image file size without losing quality. 100% processed
      ...
      <Card className="animate-fade-in-up stagger-4 backdrop-blur-md ring-border">
        ...
        <CardContent className="space-y-6">
          {!file ? (
            <ImageUploader onFileSelect={handleFileSelect} maxSizeMB={50} />
          ) : (
            <div className="space-y-6 animate-fade-in">
              ...
              {compressedFile ? (
                ...
                <FormProvider {...form}>
                  <form
                    onSubmit={form.handleSubmit(compressImage)}
                    className="space-y-6"
                  >
