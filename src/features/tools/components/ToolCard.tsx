    ...
    <Link href={`/tools/${tool.slug}`} className="group text-left">
      <SpotlightCard className="h-full p-6">
        <div className="flex items-start justify-between mb-5">
          <div className="relative flex items-center justify-center w-12 h-12 rounded-xl bg-linear-to-br from-brand/25 to-glow/15 text-brand ring-1 ring-brand/25 group-hover:shadow-[0_0_24px_-4px] group-hover:shadow-brand/50 transition-shadow duration-300">
        ...
        <h3 className="font-heading text-xl font-semibold mb-1.5">
          {tool.name}
        </h3>
